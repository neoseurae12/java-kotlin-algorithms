...
import SortAndSearch.SortArray_CountingSort;
...
class SortArrayTest {
    ...
    class QuickSortTests {
        ...
        void testPerformanceComparison() {
            int[] sortedArray = IntStream.range(0, 2_0000).toArray();
            ...
            // 성능 차이 테스트 => Naive Quicksort: 42 ms
        }
    }
    ...
    class QuickSortOptimizedTests {
        ...
        void testPerformanceComparison() {
            ...
            // 성능 차이 테스트 => Optimized Quicksort: 3 ms
            // 약 14배 성능 최적화 발생...!
        }
    }
    ...
    class CountingSortTests {
        SortArray_CountingSort sorter = new SortArray_CountingSort();
        ...
        void testPerformanceComparison() {
            ...
            System.out.println("Counting sort: " + duration / 1_000_000 + " ms");

            // 성능 차이 테스트 => Counting sort: 1 ms
            // Naive Quicksort와는 약 42배 성능 최적화 발생
            // Optimized Quicksort와도 약 3배 성능 최적화 발생
        }
    }
}